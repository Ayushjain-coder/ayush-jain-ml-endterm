...
model = pickle.load(open('mlmodelnlp_endterm.pkl','rb'))   


def review(text):
  dataset = pd.read_csv('NLP dataset 22.csv', quoting=3)
...
html_temp = """
   ...
   <center><p style="font-size:25px;color:white;margin-top:10px;"Machine Learning Lab End Term Examination</p></center> 
   </div>
   </div>
   </div>
   """
